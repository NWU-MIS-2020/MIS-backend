...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('target', models.TextField(verbose_name='课程教学目标')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='basis_templates', to='plan.IndicatorFactor', verbose_name='支撑课程以及指标系数'),
        ),
        ...
        migrations.AddConstraint(
            model_name='basistemplate',
            constraint=models.CheckConstraint(check=models.Q(full_marks__gte=0), name='full_marks_gte_0'),
        ),
    ]
